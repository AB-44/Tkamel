...
class Association extends Model
{
    ...
    public function opportunityTargets()
    {
    ...
    {
        return $this->belongsToMany(Opportunity::class, 'opportunity_targets');
    }
    ...
    public function meetingTargets()
    {
    ...
    {
        return $this->belongsToMany(Meeting::class, 'meeting_targets');
    }
