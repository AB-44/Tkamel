...
<body class="dashboard-body">
    <aside class="sidebar">
        ...
        <nav class="sb-nav">
            ...
            <a href="{{ route('dashboard') }}" class="nav-item active"><svg viewBox="0 0 24 24" fill="none"
            ...
            <a href="{{ route('consulting') }}" class="nav-item" data-vol onclick="backToVolunteer()"><svg viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2">
            ...
            <a href="{{ route('joint-projects') }}" class="nav-item"><svg viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2">
                    <path
            ...
            <div class="dash-sections">
                ...
                <div class="dash-card">
                    <div class="dash-card-header">
                        ...
                        <a href="{{ route('meetings') }}">عرض الكل</a>
                    </div>
                    <ul class="dash-list">
                ...
                <div class="dash-card">
                    <div class="dash-card-header">
                        ...
                        <a href="{{ route('joint-projects') }}">عرض الكل</a>
                    </div>
                    <ul class="dash-list">
                        <li class="dash-list-item">
                ...
                <div class="dash-card">
                    <div class="dash-card-header">
                        ...
                        <a href="{{ route('consulting') }}">عرض الكل</a>
                    </div>
                    <ul class="dash-list">
                        <li class="dash-list-item">
                ...
                <div class="dash-card">
                    <div class="dash-card-header">
                        ...
                        <a href="{{ route('orders') }}">عرض الكل</a>
                    </div>
                    <ul class="dash-list">
                        <li class="dash-list-item">
