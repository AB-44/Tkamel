...
Route::middleware(AuthMiddleware::class)->group(function () {
    ...
    Route::middleware(RoleMiddleware::class . ':user,association')->group(function () {
        ...
        Route::get('/user/meetings-page',  fn() => view('user.meetings'))->name('user.meetings.page');
        ...
        Route::post('/api/meetings/{meeting}/join', [App\Http\Controllers\MeetingController::class, 'joinMeeting'])->name('meetings.join');

        // Meetings list for users (read-only, no admin role needed)
        Route::get('/api/user/meetings', [App\Http\Controllers\MeetingController::class, 'listForUser'])->name('user.meetings.list');

        Route::get('/user/meetings',       fn() => redirect()->route('user.meetings.page'))->name('user.meetings');
...
Route::prefix('api')
    ...
    ->group(function () {
        ...
        Route::get('/association-categories',
