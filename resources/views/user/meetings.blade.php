...
<head>
  ...
  <script>
    window.meetingsList    = @json($formattedMeetings);
    window.attendingIdsList= @json($attendingIds);
    window.categoriesList  = @json($categories ?? []);
  </script>
</head>
...
<body>
  <div class="layout">
    ...
    <!-- ══ SIDEBAR ══ -->
    @include('layouts.sidebar-user', ['activeNav' => 'meetings'])

    <!-- ══ MAIN ══ -->
    <div class="main">
      <!-- TOPBAR -->
      @include('layouts.topbar', ['title' => 'الاجتماعات', 'breadcrumbs' => 'الاجتماعات'])
