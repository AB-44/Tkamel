  ...
  <div class="layout">
    ...
    <div class="main">
      ...
      <div class="content">
        ...
        {{-- ══ فرص التطوع — عرض التصنيفات (بدون أزرار إضافة) ══ --}}
        ...
        {{-- ══ ASSOCIATION VIEW (read-only browse) ══ --}}
