...
<aside class="sidebar">
  ...
  <nav class="sb-nav">
    ...
    <a class="nav-item {{ ($activeNav??'')==='service-requests' ? 'active' : '' }}" id="nav-service-requests"
       href="{{ route('consulting') }}#service-requests"
       onclick="if(typeof showSection==='function'){showSection('service-requests');return false;}">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
