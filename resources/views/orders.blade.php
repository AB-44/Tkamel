...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sb-nav">
            ...
            <a href="{{ route('dashboard') }}" class="nav-item"><svg viewBox="0 0 24 24" fill="none"
            ...
            <a href="{{ route('orders') }}" class="nav-item active" onclick="showAdminRequests(this)"><svg viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2">
