...
<aside class="sidebar">
  ...
  <nav class="sb-nav">
    ...
    <div class="nav-submenu" id="submenu-services">
      <a class="nav-sub-item" id="sub-units"       href="{{ route('consulting') }}"
         onclick="if(typeof showService==='function'){showService('units');return false;}">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>
        بناء وحدات
      </a>
      <a class="nav-sub-item" id="sub-systems"     href="{{ route('consulting') }}"
      ...
      <a class="nav-sub-item" id="sub-contact"     href="{{ route('consulting') }}"
