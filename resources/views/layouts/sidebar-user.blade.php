{{--
  ...
  User sidebar — view-only, uses user.* routes.
  Variables:
    $activeNav — 'dashboard','meetings','volunteer','orders','projects'
--}}
<aside class="sidebar">
  <div class="sb-logo">
  ...
  <nav class="sb-nav">
    ...
    <a href="{{ route('user.dashboard') }}" class="nav-item {{ ($activeNav??'')==='dashboard' ? 'active' : '' }}">
    ...
    <a href="{{ route('user.meetings') }}" class="nav-item {{ ($activeNav??'')==='meetings' ? 'active' : '' }}" id="nav-meetings">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        <rect x="3" y="4" width="18" height="18" rx="2"/>
        <path d="M16 2v4M8 2v4M3 10h18"/>
      </svg>الاجتماعات
    </a>
    <a class="nav-item {{ ($activeNav??'')==='volunteer' ? 'active' : '' }}" id="nav-volunteer"
       href="{{ route('user.consulting') }}#volunteer"
    ...
    <a class="nav-item {{ ($activeNav??'')==='projects' ? 'active' : '' }}" id="nav-projects"
       href="{{ route('user.joint-projects') }}"
    ...
    <a href="{{ route('user.services') }}" class="nav-item {{ ($activeNav??'')==='services' ? 'active' : '' }}" id="nav-services">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <a href="{{ route('user.settings') }}" class="nav-item {{ ($activeNav??'')==='settings' ? 'active' : '' }}">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
