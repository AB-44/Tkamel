  ...
  <div class="layout">
    ...
    <aside class="sidebar">
      ...
      <nav class="sb-nav">
        ...
        <a href="{{ route('dashboard') }}" class="nav-item"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <a href="{{ route('meetings') }}" class="nav-item" id="nav-meetings" onclick="openMeetingsPage()"><svg viewBox="0 0 24 24" fill="none"
        ...
        <a href="{{ route('joint-projects') }}" class="nav-item"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
