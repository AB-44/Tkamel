{{--
  partials/user-consulting/meetings.blade.php
  Meetings section for the user SPA — populated dynamically via /api/user/meetings
  (see public/js/user-meetings.js: mtgUserInit / mtgUserRefresh)
--}}
