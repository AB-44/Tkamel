                ...
                <div class="dash-widget">
                    ...
                    <ul class="dw-list">
                        ...
                        <li class="dw-item">
                            ...
                            <a href="<?php echo e(route('meetings')); ?>" class="dw-action">التفاصيل</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="dash-widget">
                    ...
                    <ul class="dw-list">
                        <li class="dw-item">
                            ...
                            <a href="<?php echo e(route('consulting')); ?>" class="dw-action">تقديم</a>
                        </li>
                        <li class="dw-item">
...
</html><?php /**PATH /home/a-22/Downloads/tkamel-fixed/tkamel/resources/views/dashboard.blade.php ENDPATH**/ ?>