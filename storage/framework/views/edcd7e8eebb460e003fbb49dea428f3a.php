...
(function() {
  ...
  window._onNotifClick = async function(id, isRead, type) {
    ...
    if (type === 'meeting_created') {
      window.location.href = '<?php echo e(route("user.meetings.page")); ?>';
...
<?php /**PATH /home/a-22/Documents/tkamel-updated (1)/tkamel/resources/views/layouts/notif-panel-user.blade.php ENDPATH**/ ?>