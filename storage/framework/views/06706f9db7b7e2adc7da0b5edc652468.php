...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('css/joint-projects.css')); ?>">
...
<body>
  ...
  <aside class="sidebar">
    ...
    <nav class="sb-nav">
      ...
      <a href="<?php echo e(route('dashboard')); ?>" class="nav-item"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
          stroke-width="2">
      ...
      <a href="<?php echo e(route('consulting')); ?>" class="nav-item" data-vol onclick="backToVolunteer()"><svg
          viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <a href="<?php echo e(route('joint-projects')); ?>" class="nav-item active"><svg viewBox="0 0 24 24" fill="none"
...
</html><?php /**PATH /home/a-22/Tkamel_project/المشروع الحالي/Tkamel_merged/tkamel_merged/resources/views/joint-projects.blade.php ENDPATH**/ ?>