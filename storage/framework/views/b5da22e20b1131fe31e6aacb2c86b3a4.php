...
<body>
    <?php echo $__env->make('layouts.sidebar-admin', ['activeNav' => 'my-associations'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <!-- ══ MAIN ══ -->
    <div class="main">
        <!-- TOPBAR -->
        <?php echo $__env->make('layouts.topbar', ['title' => 'الجمعيات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="content">
            ...
            <div style="background-color: rgba(16, 185, 129, 0.1); color: #059669; padding: 16px 24px; border-radius: 14px; margin-bottom: 24px; border: 1px solid rgba(16, 185, 129, 0.2); display: flex; align-items: center; gap: 12px; font-weight: 700;">
                <i class="fa-solid fa-circle-check" style="font-size: 1.2rem;"></i> <?php echo e(session('success')); ?>
            ...
            <div class="stats-row">
                <div class="stat-card">
                    ...
                    <div>
                        <span class="stat-num"><?php echo e($totalAssociations); ?></span>
                ...
                <div class="stat-card">
                    ...
                    <div>
                        <span class="stat-num"><?php echo e($recentAssociations); ?></span>
                ...
                <div class="stat-card">
                    ...
                    <div>
                        <span class="stat-num"><?php echo e(count($categoriesCount)); ?></span>
            ...
            <!-- TOOLBAR -->
            <form class="toolbar" method="GET" action="<?php echo e(route('my-associations.index')); ?>">
                <div class="search-wrap">
                    <i class="fa-solid fa-magnifying-glass"></i>
                    <input type="text" name="search" class="search-input" value="<?php echo e(request('search')); ?>" placeholder="ابحث باسم الجمعية، البريد، الهاتف، التصنيف...">
                </div>
                ...
                <select name="category" class="filter-select" onchange="this.form.submit()">
                    ...
                    ?>
                    <?php $__currentLoopData = $availableCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <a href="<?php echo e(route('my-associations.index')); ?>" class="btn-clear" title="إلغاء التصفية">
            ...
            <div class="assoc-grid">
                <?php $__empty_1 = true; $__currentLoopData = $associations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assoc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="assoc-card">
                    <div class="assoc-header">
                        <?php if(isset($assoc->logo_url) && $assoc->logo_url): ?>
                            <img src="<?php echo e($assoc->logo_url); ?>" alt="Logo" class="assoc-logo">
                        <?php else: ?>
                            <div class="assoc-logo-fallback">
                                <?php echo e(mb_substr($assoc->association_name, 0, 1)); ?>

                            </div>
                        <?php endif; ?>
                        <div class="assoc-title-wrap">
                            <div class="assoc-title"><?php echo e($assoc->association_name); ?></div>
                            <div class="assoc-desc"><?php echo e($assoc->admin_notes ?: $assoc->category ?: 'جمعية مسجلة وموثقة ضمن شبكة تكامل التعاونية.'); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="assoc-info">
                        ...
                        <div class="info-row">
                            ...
                            <a href="mailto:<?php echo e($assoc->email); ?>" dir="ltr"><?php echo e($assoc->email); ?></a>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="info-row">
                            ...
                            <a href="tel:<?php echo e($assoc->phone); ?>" dir="ltr"><?php echo e($assoc->phone); ?></a>
                        </div>
                        <?php endif; ?>
                        
                        <div class="info-row">
                            <i class="fa-solid fa-globe"></i>
                            <a href="#" target="_blank" dir="ltr">https://<?php echo e(Str::slug($assoc->association_name ?: 'tkamel-assoc')); ?>.org</a>
                        </div>
                    </div>
                    ...
                    <div class="assoc-footer">
                        ...
                        <div class="assoc-actions">
                            <button type="button" class="btn-edit" onclick="alert('تعديل الجمعية: <?php echo e($assoc->association_name); ?>')">
                                <i class="fa-regular fa-pen-to-square"></i> Edit
                            </button>
                            <form action="<?php echo e(route('my-associations.destroy', $assoc->id)); ?>" method="POST" onsubmit="return confirm('هل أنت متأكد من حذف هذه الجمعية نهائياً؟');" style="margin: 0;">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH /home/a-22/Downloads/tkamel-updated (2)/tkamel/resources/views/my-associations.blade.php ENDPATH**/ ?>