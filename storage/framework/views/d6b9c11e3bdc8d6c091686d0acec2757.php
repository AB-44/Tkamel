...
<body>
  <div class="layout">
    ...
    <div class="main">
      ...
      <!-- TOPBAR -->
      <?php echo $__env->make('layouts.topbar', ['title' => 'فرص التطوع', 'userName' => 'مبادرون (أدمن)', 'userAv' => 'م'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="view" id="view-orders">
          ...
          <div class="modal-overlay" id="action-modal">
            <div class="modal" style="max-width:480px; padding:0; overflow:hidden">
              <div class="modal-head" style="background:linear-gradient(135deg,#1a6b7c,#2ab8d0);padding:18px 20px;border-bottom:none;border-radius:18px 18px 0 0;position:relative;display:flex;align-items:center;justify-content:space-between;">
                <button class="btn btn-ghost" onclick="closeActionModal()" style="position:absolute; top:10px; left:14px; padding:.3rem .5rem; background:rgba(255,255,255,.15); border:none; border-radius:50%; width:28px; height:28px; display:flex; align-items:center; justify-content:center; color:#fff; font-size:.9rem; cursor:pointer;">✕</button>
                <div style="display:flex;align-items:center;gap:8px;flex:1;justify-content:flex-end;">
                  <span id="action-modal-title" style="font-weight:800;font-size:1.1rem;color:#fff">طلب تعديل البيانات</span>
                  <span id="action-modal-icon" style="font-size:1.2rem;">✏️</span>
                </div>
              </div>
              <div style="text-align:center;padding:10px 20px 4px;background:#fff;">
                <div id="action-modal-sub" style="font-size:.9rem;color:#64748b;font-weight:600">جمعية: الاتحاد</div>
              </div>
              <div class="modal-body" style="padding:20px;background:#fff;">
                <div style="margin-bottom:12px; text-align:right">
                  <label id="action-notes-label" style="display:block;font-size:.9rem;font-weight:700;color:var(--text);margin-bottom:8px">التعديلات المطلوبة *</label>
                  <textarea id="action-notes" rows="4"
                    style="width:100%;border:1.5px solid var(--border-color);border-radius:12px;padding:12px 16px;font-family:'Tajawal',sans-serif;font-size:.95rem;color:var(--text);resize:vertical;outline:none;transition:border .2s; background:#f9fafb"
                    onfocus="this.style.borderColor='var(--teal)';this.style.background='#fff'"
                    onblur="this.style.borderColor='var(--border-color)';this.style.background='#f9fafb'"
                    placeholder="أدخل التعديلات المطلوبة..."></textarea>
                </div>
              </div>
              <div class="modal-footer" style="padding:16px 20px;border-top:1px solid #e2e8f0;display:flex;justify-content:center;gap:12px;background:#fff;border-radius:0 0 18px 18px;">
                <button class="btn-pill-cancel" onclick="closeActionModal()">إلغاء</button>
                <button id="action-confirm-btn" class="btn-pill-review" onclick="confirmAction()">إرسال طلب التعديل ✏️</button>
              </div>
            </div>
          </div>
        </div>
...
</html><?php /**PATH /home/a-22/Downloads/tkamel-fixed/tkamel/resources/views/consulting.blade.php ENDPATH**/ ?>