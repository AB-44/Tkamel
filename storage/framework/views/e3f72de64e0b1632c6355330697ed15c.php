...
<aside class="sidebar">
  ...
  <nav class="sb-nav">
    ...
    <a class="nav-item <?php echo e(($activeNav??'')==='volunteer' ? 'active' : ''); ?>" id="nav-volunteer"
       href="<?php echo e(route('user.consulting')); ?>#volunteer"
    ...
    <a href="<?php echo e(route('user.settings')); ?>" class="nav-item <?php echo e(($activeNav??'')==='settings' ? 'active' : ''); ?>">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<?php /**PATH /home/a-22/Documents/tkamel-updated (1)/tkamel/resources/views/layouts/sidebar-user.blade.php ENDPATH**/ ?>