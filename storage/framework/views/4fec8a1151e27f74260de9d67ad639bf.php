...
<aside class="sidebar">
  ...
  <nav class="sb-nav">
    ...
    <a class="nav-item <?php echo e(($activeNav??'')==='orders' ? 'active' : ''); ?>" id="nav-orders"
      ...
      </svg>الجمعيات و الطلبات<span class="nav-badge red" id="nb-reqs"></span>
    </a>
    ...
    <a class="nav-item <?php echo e(($activeNav??"")==='settings' ? 'active' : ''); ?>" href="<?php echo e(route('settings')); ?>">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<?php /**PATH /home/a-22/Downloads/tkamel-updated (2)/tkamel/resources/views/layouts/sidebar-admin.blade.php ENDPATH**/ ?>