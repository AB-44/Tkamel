...
<body>
<?php echo $__env->make('layouts.sidebar-user', ['activeNav' => 'settings'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          ...
          <div class="form-grid">
            <div class="form-group">
              ...
              <input type="text" class="form-input" id="full-name"
                     value="<?php echo e(Auth::user()->full_name ?? 'مستخدم'); ?>" placeholder="أدخل الاسم الكامل">
            </div>
            <div class="form-group">
              <label class="form-label">البريد الإلكتروني</label>
              <input type="email" class="form-input" id="email"
                     value="<?php echo e(Auth::user()->email ?? ''); ?>" placeholder="أدخل البريد الإلكتروني">
            </div>
            <div class="form-group">
...
<?php /**PATH /home/a-22/Documents/tkamel-updated (1)/tkamel/resources/views/user/settings.blade.php ENDPATH**/ ?>