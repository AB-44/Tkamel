...
<body>
  <div class="layout">
    ...
    <?php echo $__env->make('layouts.sidebar-admin', ['activeNav' => 'meetings'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="overlay" id="ov-create" onclick="bgClose(event,'ov-create')">
      <div class="modal" onclick="event.stopPropagation()">
        <div class="modal-hd">
          <div class="modal-hd-icon" id="mhd-icon"><i class="fa-regular fa-calendar"></i></div>
        ...
        <div class="modal-ft">
          ...
          <button class="btn-save" onclick="saveMeeting()"><span id="save-lbl"><i class="fa-solid fa-floppy-disk" style="margin-left:8px"></i> حفظ الاجتماع</span></button>
        </div>
      </div>
    </div>
...
</html><?php /**PATH /home/a-22/Tkamel_project/tkamel/resources/views/meetings.blade.php ENDPATH**/ ?>