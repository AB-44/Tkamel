...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .brand-logo-wrap { display:flex; align-items:center; justify-content:center; margin-bottom:12px; width:100%; }
    .brand-logo-img {
      width:100%; max-width:400px; height:240px; object-fit:contain;
    ...
    <div class="brand-panel">
      ...
      <div class="brand-content">
        <div class="brand-logo-wrap">
          <img class="brand-logo-img" src="<?php echo e(asset('images/Gemini_Generated_Image_tlotq1tlotq1tlot (1) (1).png')); ?>" alt="تكامل">
        </div>
              ...
              <div class="cat-grid">
                <?php if(isset($categories) && count($categories) > 0): ?>
                  <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label class="cat-chip"><input type="radio" name="cat" value="<?php echo e($cat->name); ?>"> <?php echo e($cat->icon ?? '📁'); ?> <?php echo e($cat->name); ?></label>
...
<?php /**PATH C:\xampp\htdocs\tkamel-abdullah1\tkamel\resources\views/auth/login.blade.php ENDPATH**/ ?>