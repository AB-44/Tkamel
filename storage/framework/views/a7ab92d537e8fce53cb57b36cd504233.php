...
<body class="dashboard-body">
    ...
    <div class="main">
        ...
        <div class="content">
            <div class="page-hd">
                <div>
                    <div class="ph-title">مرحباً، <?php echo e(Auth::user()->full_name); ?> 👋</div>
...
<?php /**PATH /home/testuser/Downloads/Tkamel-main/resources/views/user/dashboard.blade.php ENDPATH**/ ?>