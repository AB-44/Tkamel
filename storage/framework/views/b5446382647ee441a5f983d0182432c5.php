...
<aside class="sidebar">
  ...
  <div class="sb-profile">
    <div class="sb-profile-av"><?php echo e($avatarLetter); ?></div>
    <div class="sb-profile-info">
      <div class="sb-profile-name"><?php echo e($displayName); ?></div>
      <div class="sb-profile-role"><?php echo e($displayRole); ?></div>
    </div>
  ...
  <nav class="sb-nav">
    ...
    <a href="<?php echo e(route('user.meetings')); ?>"
       class="nav-item <?php echo e($nav==='meetings' ? 'active' : ''); ?>"
       id="nav-meetings">
      <div class="nav-icon">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
             stroke-linecap="round" stroke-linejoin="round">
    ...
    <a href="<?php echo e(route('user.consulting')); ?>"
       class="nav-item <?php echo e($nav==='volunteer' ? 'active' : ''); ?>"
       id="nav-volunteer">
      <div class="nav-icon">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
             stroke-linecap="round" stroke-linejoin="round">
    ...
    <a href="<?php echo e(route('user.joint-projects')); ?>"
       class="nav-item <?php echo e($nav==='projects' ? 'active' : ''); ?>"
       id="nav-projects">
      <div class="nav-icon">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
             stroke-linecap="round" stroke-linejoin="round">
    ...
    <a href="<?php echo e(route('user.services')); ?>"
       class="nav-item <?php echo e($nav==='services' ? 'active' : ''); ?>"
       id="nav-services">
      <div class="nav-icon">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
             stroke-linecap="round" stroke-linejoin="round">
    ...
    <a href="<?php echo e(route('user.settings')); ?>"
       class="nav-item <?php echo e($nav==='settings' ? 'active' : ''); ?>"
       id="nav-settings">
      <div class="nav-icon">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
             stroke-linecap="round" stroke-linejoin="round">
...
<?php /**PATH C:\xampp\htdocs\tkamel-abdullah1\tkamel\resources\views/layouts/sidebar-user.blade.php ENDPATH**/ ?>