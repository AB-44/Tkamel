...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/user-my-requests.css')); ?>?v=<?php echo e(time()); ?>">
</head>

<body>

    <!-- ══ SIDEBAR ══ -->
    <?php echo $__env->make('layouts.sidebar-user', ['activeNav' => 'orders'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <!-- ══ MAIN ══ -->
    <div class="main-wrapper">

        <!-- TOPBAR -->
        <?php echo $__env->make('layouts.topbar', ['title' => 'طلباتي', 'crumb' => 'الرئيسية / طلباتي'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="content mr-content">
            ...
            <div class="mr-stats-grid">
                <div class="mr-stat-card" style="border-right-color: #0ea5c9;">
                    ...
                    <div class="mr-stat-text-group">
                        <div class="mr-stat-val"><?php echo e($stats['total_requests'] ?? 0); ?></div>
                ...
                <div class="mr-stat-card" style="border-right-color: #f59e0b;">
                    ...
                    <div class="mr-stat-text-group">
                        <div class="mr-stat-val"><?php echo e($stats['pending_requests'] ?? 0); ?></div>
                ...
                <div class="mr-stat-card" style="border-right-color: #10b981;">
                    ...
                    <div class="mr-stat-text-group">
                        <div class="mr-stat-val"><?php echo e($stats['approved_requests'] ?? 0); ?></div>
                ...
                <div class="mr-stat-card" style="border-right-color: #ef4444;">
                    ...
                    <div class="mr-stat-text-group">
                        <div class="mr-stat-val"><?php echo e($stats['rejected_requests'] ?? 0); ?></div>
            ...
            <div class="mr-tabs">
                <button class="mr-tab active" data-tab="all">
                    ...
                    <span class="mr-tab-badge"><?php echo e($stats['total_requests'] ?? 0); ?></span>
                </button>
                <button class="mr-tab" data-tab="opportunity">
                    <i class="fa-solid fa-user-tie"></i> فرص التطوع
                    <span class="mr-tab-badge"><?php echo e($allRequests->where('type', 'opportunity')->count()); ?></span>
                </button>
                <button class="mr-tab" data-tab="project">
                    <i class="fa-solid fa-diagram-project"></i> المشاريع المشتركة
                    <span class="mr-tab-badge"><?php echo e($allRequests->where('type', 'project')->count()); ?></span>
                </button>
                <button class="mr-tab" data-tab="service">
                    <i class="fa-solid fa-suitcase-medical"></i> خدمات مبادرون
                    <span class="mr-tab-badge"><?php echo e($allRequests->where('type', 'service')->count()); ?></span>
                </button>
            </div>
            ...
            <div class="mr-list-container" id="requests-list">
                <?php $__empty_1 = true; $__currentLoopData = $allRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="mr-req-card"
                         ...
                         data-type="<?php echo e($req->type); ?>"
                         data-id="<?php echo e($req->id); ?>"
                         data-title="<?php echo e(e($req->title)); ?>"
                         data-sub="<?php echo e(e($req->sub)); ?>"
                         data-date="<?php echo e(\Carbon\Carbon::parse($req->date)->translatedFormat('d M Y')); ?>"
                         data-status-label="<?php echo e($statusLabel); ?>"
                         data-status-class="<?php echo e($statusClass); ?>"
                         data-color="<?php echo e($req->color); ?>"
                         data-icon="<?php echo e($req->icon); ?>"
                         data-notes="<?php echo e(e($req->notes ?? '')); ?>"
                         <?php if($req->type === 'service'): ?>
                         data-service-type="<?php echo e($req->service_type ?? ''); ?>"
                         data-budget="<?php echo e(e($req->budget ?? '')); ?>"
                         data-preferred-date="<?php echo e($req->preferred_date ? \Carbon\Carbon::parse($req->preferred_date)->translatedFormat('d M Y') : ''); ?>"
                         data-preferred-date-raw="<?php echo e($req->preferred_date ?? ''); ?>"
                         data-details="<?php echo e(e($req->details ?? '')); ?>"
                         <?php endif; ?>
                         <?php if($req->type === 'opportunity'): ?>
                         data-deadline="<?php echo e($req->opportunity?->deadline ? \Carbon\Carbon::parse($req->opportunity->deadline)->translatedFormat('d M Y') : ''); ?>"
                         data-opp-desc="<?php echo e(e($req->opportunity?->description ?? '')); ?>"
                         <?php endif; ?>
                         <?php if($req->type === 'project'): ?>
                         data-project-desc="<?php echo e(e($req->project?->description ?? '')); ?>"
                         <?php endif; ?>
                    >
                        <div class="mr-req-icon" style="background: <?php echo e($req->color); ?>1a; color: <?php echo e($req->color); ?>;">
                            <i class="fa-solid <?php echo e($req->icon); ?>"></i>
                        </div>
                        <div class="mr-req-info">
                            <div class="mr-req-title"><?php echo e($req->title); ?></div>
                            <div class="mr-req-sub"><?php echo e($req->sub); ?></div>
                        </div>
                        <div class="mr-req-date"><?php echo e(\Carbon\Carbon::parse($req->date)->translatedFormat('d M Y')); ?></div>
                        <div class="mr-req-status">
                            <span class="mr-badge <?php echo e($statusClass); ?>"><?php echo e($statusLabel); ?></span>
                        </div>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="mr-empty">
                        <img src="<?php echo e(asset('images/mailbox.png')); ?>" alt="Empty Mailbox" style="width: 80px; margin-bottom: 1rem; opacity: 0.8;" onerror="this.outerHTML='<div style=\'font-size:4rem; margin-bottom: 1rem;\'>📫</div>'">
                        <h3>لا توجد طلبات</h3>
...
<?php /**PATH C:\xampp\htdocs\tkamel-abdullah1\tkamel\resources\views/user/my-requests.blade.php ENDPATH**/ ?>