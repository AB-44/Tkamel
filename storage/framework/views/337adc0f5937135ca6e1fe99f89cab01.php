...
<div id="notif-panel" class="notif-panel-container" style="display:none;">
  ...
  <div class="notif-footer">
    <a href="<?php echo e(route('user.meetings')); ?>" class="notif-footer-link">
...
(function() {
  ...
  window._onNotifClick = async function(id, isRead, type) {
    ...
    if (type === 'meeting_created') {
      window.location.href = '<?php echo e(route("user.meetings")); ?>';
    } else if (type === 'opportunity_approved' || type === 'opportunity_rejected') {
      window.location.href = '<?php echo e(route("user.consulting")); ?>';
    } else if (type === 'project_join_approved' || type === 'project_join_rejected') {
      window.location.href = '<?php echo e(route("user.consulting")); ?>';
    } else {
      window.location.href = '<?php echo e(route("user.services")); ?>';
    }
  };
...
<?php /**PATH C:\xampp\htdocs\tkamel-abdullah1\tkamel\resources\views/layouts/notif-panel-user.blade.php ENDPATH**/ ?>